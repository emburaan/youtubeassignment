...
import com.assignment.youtubedata.databinding.NetworkStateItemBinding


class VideosLoadingStateAdapter(private val retry: () -> Unit) :
    LoadStateAdapter<VideosLoadingStateAdapter.LoadStateViewHolder>() {
